...
func UnmarshalPipeline(data []byte) Pipeline {
...
func UnmarshalPipelineConfig(data []byte) PipelineConfig {
...
func ReadPipelineJSONFromFile(path string) Pipeline {
...
func pipelineConfigPOST(gocdULR string, pipelineConfig PipelineConfig) Pipeline {
...
func pipelineGET(gocdULR string, pipelineName string) Pipeline {
